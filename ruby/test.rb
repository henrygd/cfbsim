...
# # Output team objects
# TEAM_HASH.each do |k, v|
#   puts "Team.new(name:\"#{k}\", pass_offense: #{v[:pass_offense]}, pass_defense: #{v[:pass_defense]}, run_offense: #{v[:run_offense]}, run_defense: #{v[:run_defense]}, lundgren: #{v[:lundgren]}, quality_ppg: #{v[:quality_ppg]}, special_teams: #{v[:special_teams]}),"
# end
